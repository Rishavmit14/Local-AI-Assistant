...
export function CanonicalLearn({ navigate }: { navigate: (view: "lab") => void }) {
  ...
  const send = async (text: string) => {
    ...
    try { await presentation.current.continueLearn(text, (chunk) => setReply((old) => old + chunk)); view.reload(); }
