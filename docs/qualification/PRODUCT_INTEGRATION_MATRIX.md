...
| 26. Career Forge core | `CareerForgeService`, graph/missions/evidence | truthful awareness only; tutor remains separate | journey panel | CF SQLite | Learner Twin writes deterministic | panel/API or ask Friday what exists | live Friday answer no longer denied Career Forge and stated Practice Lab limitation | INTEGRATED | no conversational tutor handoff or Practice Lab | Career Forge advanced integration | 9, 10 | E2E-011/012 |
