...
| 33. Automatic assistance tracking | lesson directive calls `offer_assistance` | normal Friday help route | No | CF SQLite | deterministic write only, exact content/level retained | ask Friday for a hint | physical hint was spoken and persisted with active mission | QUALIFIED | no visual history surface | later expose truthful history | 32 | assistance evidence flow |
| 34. Mastery evidence | attempts, semantic assessment, evidence + one-rung advance | normal Friday attempt/check/teach-back route | No | CF SQLite | model opinion cannot advance; only correct assessment records typed evidence; explicit one-rung advance remains separate | answer/check or teach back | physical correct quiz evidence, incorrect teach-back retry, and no auto-mastery passed | QUALIFIED | no mastery/progress UI expansion | later render existing records truthfully | 27 | teach/attempt/evidence E2E |
