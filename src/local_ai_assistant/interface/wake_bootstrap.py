    ...
    _LATENCY_STAGES = frozenset(
        {
            ...
            "CAREER_FORGE_PROJECTION_BEGIN",
            "CAREER_FORGE_PROJECTION_COMPLETE",
            "ACTIVE_SESSION_PROJECTION_BEGIN",
            "ACTIVE_SESSION_PROJECTION_COMPLETE",
            "MEMORY_RETRIEVAL_BEGIN",
            ...
            "CAPABILITY_PROJECTION_BEGIN",
            "CAPABILITY_PROJECTION_COMPLETE",
            "COGNITIVE_POLICY_BEGIN",
            "COGNITIVE_POLICY_COMPLETE",
